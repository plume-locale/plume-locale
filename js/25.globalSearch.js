        ...
        // MVVM: ViewModel — état local pour le debounce de la recherche.
                let searchTimeout = null;

        // MVVM: ViewModel — traite l'entrée utilisateur pour la recherche globale,
        // gère le debounce puis déclenche la recherche et l'affichage des résultats.
        ...
        // MVVM: ViewModel — parcourt les données du `project` (Model), trouve les
        // correspondances et transforme ces données en objets prêts pour la View.
        ...
        // MVVM: ViewModel — utilitaire de transformation pour générer un extrait autour
        // de la correspondance (préparation pour la View).
        ...
        // MVVM: View — responsable du rendu DOM des résultats de recherche.
        ...
        // MVVM: ViewModel — exécute l'action associée au résultat (pont entre View et actions).
        ...
        // MVVM: View — logique d'interface pour fermer les résultats de recherche.
                function closeSearchResults() {
                    document.getElementById('searchResults').classList.remove('active');
                    document.getElementById('globalSearch').value = '';
                }

        // MVVM: View — écoute globale pour fermer les résultats au clic extérieur.
