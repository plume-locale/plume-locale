// Migrated from js/03.project.js

// Project and view management functions
...
function switchView(view) {
    ...
    if (isMobile && sidebarViews[view]) {
        ...
        if (editorView) {
            // Content will be filled by render functions
        }
    }
...
// Text Analysis Tools (included here because they were in the same source)
