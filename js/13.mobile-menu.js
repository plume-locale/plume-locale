...
// ============================================
       ...
       // ========================================
        ...
        function toggleMobileSidebar() {
            ...
            console.log('?? toggleMobileSidebar appel�');
        ...
        function toggleMobileNav() {
            ...
            // D�terminez si le menu est actif (ouvert)
            if (dropdown.classList.contains('active')) {
                // Fermer le menu
                dropdown.classList.remove('active');
                toggleBtn.innerHTML = menuIcon; // Remplacer par l'ic�ne 'Menu'
                if (sidebar) sidebar.style.visibility = '';
            } else {
                // Ouvrir le menu
                dropdown.classList.add('active');
                toggleBtn.innerHTML = closeIcon; // Remplacer par l'ic�ne 'X'
        ...
        function toggleLinksPanel() {
            ...
            if (panel.classList.contains('expanded')) {
                ...
                if (toggleText) toggleText.innerHTML = '<i data-lucide="chevron-right" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;"></i>Afficher personnages & lieux li�s';
                if (toggleBtn) toggleBtn.classList.remove('expanded');
                if (typeof lucide !== 'undefined') lucide.createIcons();
            } else {
                panel.classList.add('expanded');
                if (toggleText) toggleText.innerHTML = '<i data-lucide="chevron-down" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;"></i>Masquer personnages & lieux li�s';
                if (toggleBtn) toggleBtn.classList.add('expanded');
                if (typeof lucide !== 'undefined') lucide.createIcons();
            }
        }
        ...
        // D�tection dynamique du d�bordement du header
        ...
        window.addEventListener('resize', function() {
            ...
            resizeTimeout = setTimeout(function() {
                // V�rifier le d�bordement du header
                checkHeaderOverflow();
