...
// Notes Management
        ...
        function addNote() {
            ...
            const note = {
                ...
                content: content || '',
                medias: [], // Support pour les m�dias: {type: 'url'|'image'|'audio', url: '', title: ''}
        ...
        function deleteNote(id) {
            if (!confirm('�tes-vous s�r de vouloir supprimer cette note ?')) return;
        ...
        let expandedNoteCategories = new Set(['Id�e', 'Recherche', 'R�f�rence', 'A faire', 'Question', 'Autre']);
        ...
        function renderNotesList() {
            ...
            const categories = {};
            // Ic�nes Lucide pour les cat�gories
            const categoryIcons = {
                'Id�e': 'lightbulb',
                'Recherche': 'search',
                'R�f�rence': 'bookmark',
            ...
            const categoryOrder = ['Id�e', 'Recherche', 'R�f�rence', 'A faire', 'Question', 'Autre'];
                    ...
                    <div class="treeview-group" data-category="${cat}">
                        ...
                        <div class="treeview-children ${isExpanded ? '' : 'collapsed'}">
                            ${categories[cat].map(note => {
                                ...
                                // Remplacement du ?? par l'ic�ne de trombone
        ...
        function expandAllNoteCategories() {
            expandedNoteCategories = new Set(['Id�e', 'Recherche', 'R�f�rence', 'A faire', 'Question', 'Autre']);
            renderNotesList();
        }
            ...
            editorView.innerHTML = `
                <div class="detail-view">
                    ...
                    <div class="detail-section">
                        <div class="detail-section-title">Cat�gorie</div>
                        <select class="form-input" onchange="updateNoteField(${id}, 'category', this.value)">
                            ...
                            <option value="Id�e" ${note.category === 'Id�e' ? 'selected' : ''}>Id�e</option>
                            <option value="R�f�rence" ${note.category === 'R�f�rence' ? 'selected' : ''}>R�f�rence</option>
                            <option value="A faire" ${note.category === 'A faire' ? 'selected' : ''}>� faire</option>
                    ...
                    <div class="detail-section">
                        ...
                        <small style="color: var(--text-muted); font-style: italic;">S�parez les tags par des virgules</small>
                    </div>
        ...
        function renderNoteMedias(note) {
            if (!note.medias || note.medias.length === 0) {
                return '<div style="color: var(--text-muted); font-style: italic; padding: 1rem; text-align: center; border: 1px dashed var(--border-color); border-radius: 8px;">Aucun m�dia ajout�</div>';
            }
                ...
                if (media.type === 'image') {
                    ...
                    return `
                        <div class="note-media-item note-media-youtube">
                            ...
                            <div class="note-media-overlay">
                                <span class="note-media-title">${media.title || 'Vid�o YouTube'}</span>
                                <button class="note-media-delete" onclick="deleteNoteMedia(${note.id}, ${index})">�</button>
                            </div>
                        </div>
                    `;
                ...
                <div class="modal-content" style="max-width: 500px;">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-label">Type de m�dia</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="mediaTitleInput" class="form-input" placeholder="Titre du m�dia">
                        </div>
                        <div class="form-group">
