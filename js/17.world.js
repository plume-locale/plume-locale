...
// World Management
        ...
        function deleteWorldElement(id) {
            if (!confirm('�tes-vous s�r de vouloir supprimer cet �l�ment ?')) return;
        ...
        function renderElementLinkedScenes(element) {
            ...
            return `
                <div class="detail-section">
                    <div class="detail-section-title"><i data-lucide="file-text" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;"></i>Appara�t dans ${scenes.length} sc�ne(s)</div>
                ...
                <div class="detail-view">
                    ...
                    <div class="detail-section">
                        ...
                        <select class="form-input" onchange="updateWorldField(${id}, 'type', this.value)">
                            ...
                            <option value="�v�nement" ${element.type === '�v�nement' ? 'selected' : ''}>�v�nement</option>
                        </select>
                    </div>
