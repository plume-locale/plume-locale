...
// Version Control Management - Plume Writer
// ============================================

        // Version Control Management
        function createVersion() {
            const label = prompt('Nom de la version (ex: "Version 1.0", "Avant r�vision", etc.)');
        ...
        function deleteVersion(id) {
            if (!confirm('�tes-vous s�r de vouloir supprimer cette version ?')) return;
        ...
        function restoreVersion(id) {
            if (!confirm('?? ATTENTION: Restaurer cette version va remplacer votre travail actuel. Voulez-vous cr�er une sauvegarde avant de continuer ?')) {
                return;
            }
