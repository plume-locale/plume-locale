...
/* Removed duplicate raw HTML toolbar block (accidentally inserted here during build).
   The toolbar markup exists in the editor rendering functions; this shim should not contain raw HTML. */
