...
{footer}"""
    ...
    # Écrire le fichier
    # L'output_file est maintenant géré par la partie __main__ et ne doit pas être None ici.
    # On utilise os.path.basename(output_file) si nécessaire, mais ici on a déjà le nom complet.
...
if __name__ == "__main__":
    ...
    default_output = f'plume-build-{timestamp}.html'
    ...
    # La fonction log n'est pas encore initialisée ici, on utilise print (la fonction log est initialisée DANS build())
